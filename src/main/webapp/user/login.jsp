...
<div class="container">
    ...
    <form class="form-signin" method="POST" action="${pageContext.request.contextPath}/user/login.jsp"
        ...
        <div class="row">
            <div class="col-md-6">
                <input class="btn btn-danger" id="submit" name="submit" type="button" value="不能登陆，检查邮箱和密码格式" disabled
                       onclick="authorize()"/>
                <a class="btn btn-info" href="${pageContext.request.contextPath}/user/register.jsp">没有账户？点此注册</a>
                <a class="btn btn-primary" href="${pageContext.request.contextPath}/user/passwordReset.jsp">忘记密码</a>
            </div>
        </div>
        <br>
        <p id="success"></p>
